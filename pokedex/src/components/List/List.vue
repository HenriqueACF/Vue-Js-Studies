<template>
  <ul class="list text--white bg--black">
    <p v-if="isSearching" class="list--message">Procurando por Pokemons</p>
    <p v-else-if="hasSearchError" class="list--message">Não foi possivel encontras este Pokemon</p>
