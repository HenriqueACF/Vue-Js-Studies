...
export default{
    ...
    //add pokemons to the pokedex for the infinite loading
    setList(list){
    ...
    //informs is the pokedex has finished fetching data
    ...
    //resets the pokedex to the las cache and removes search information
    resetList(){
